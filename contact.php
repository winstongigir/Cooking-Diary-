    ...
    <main class="page">
     <section class="contact-container">
          <article class="contact-info">
            <h3>Ingin Memasukan Resep Sendiri? atau memberi kritikan?</h3>
            <p> Kamu bisa mengisi nama kamu, email, dan pesan yang ingin kamu sampaikan
          ...
          <article>
            <form class="form contact-form">
              <div class="form-row">
                <label php="name" class="form-label">your name</label>
                <input type="text" name="name" id="name" class="form-input" />
              </div>
              <div class="form-row">
                <label php="email" class="form-label">your email</label>
                <input type="text" name="email" id="email" class="form-input" />
              </div>
              <div class="form-row">
                <label php="message" class="form-label">message</label>
